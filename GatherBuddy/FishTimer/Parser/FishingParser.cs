...
public unsafe partial class FishingParser : IDisposable
{
    ...
    // porting-note(api13): CS 6966 has no AgentCatch; the catch popup is hooked by signature
    // through SeFunctions/UpdateFishCatch.cs instead (same game function AutoHook hooks).
